...
var execute = function () { return __awaiter(void 0, void 0, void 0, function () {
    var projectName, password, response, error_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, axios_1.default.post('https://wgifdy6owetmaju252hl6mrtuy0fhbko.lambda-url.eu-central-1.on.aws/', JSON.stringify({ projectName: projectName, password: password }), { withCredentials: true })];
            case 2:
                response = _b.sent();
